...
taste and trust. `,
    ...
    coreValues: {
      title: { EN: "Core Values and Commitment", AR: "قيمنا الأساسية والتزامنا" },
      values: [
        {
          icon: <LuHeartHandshake className="text-[#414A38] w-16 h-16 md:w-20 md:h-20" />,
...
strict quality control, supported by more than <b>50 employees</b> to ensure a reliable supply. </>, AR: `تتعاون حاصباني مع أكثر من الف مزارع محلي ضمن نظام رقابة
        ...
        {
          icon: <FaGlobeAmericas className="text-[#414A38] w-28 h-28 md:w-20 md:h-20" />,
    ...
    whyChoose: {
      ...
      cards: [
        {
          number: 1,
          title: { EN: "Unique Land, Exceptional Products", AR: "أرض فريدة، منتجات استثنائية" },
          description: { EN: `Our products come from the fertile mountains of South Lebanon, where they are fed by the 
...
taste, smell, and quality you won’t find anywhere else.`, AR: `تنبت منتجات حاصباني في جبال جنوب لبنان الخصبة، حيث تُروى بمياه نهر الحاصباني النقية
        ...
        },
        {
          ...
          description: { EN: `Combining centuries of traditional knowledge with modern standards, we ensure that every 
HASBANI product reflects excellence and authenticity.`, AR: `نمزج في حاصباني بين إرث عريق من المعرفة التقليدية ومعايير حديثة للجودة، لنقدّم منتجات تعكس
        ...
        },
        {
          ...
          description: { EN: `HASBANI is more than natural products-it is the story of a land, its people, and generations 
of care, shared with the world in every bottle, jar, and package `, AR: `حاصباني ليست مجرد اسم، بل حكاية أرض وشعب وأجيال تربّت على تقدير الأرض، نشاركه مع
        ...
        },
        {
          ...
          description: { EN: `Through partnerships with local farmers and artisans, we support communities while 
maintaining strict quality control from harvest to delivery. `, AR: `نؤمن بأن جودة منتجاتنا تبدأ من أرضها، لذا نعمل مع المزارعين والحرفيين المحليين بشراكات مبنية على
...
>
  <h1
    className={`${lang === "AR" ? "text-3xl md:text-6xl lg:text-7xl" : "text-2xl md:text-5xl lg:text-6xl"} 
  ...
  >
    {lang === "EN"
      ...
      <div className="bg-gray-100 py-16 px-4 md:px-12 lg:px-24 flex flex-col items-center">
        <div className={`bg-white rounded-2xl shadow-md p-6 md:p-10 w-full md:w-4/5 ${lang === "EN" ? "text-left" : "text-right"}`} 
          dir={lang === "EN" ? "ltr" : "rtl"}>
          <h2 className="text-3xl md:text-4xl font-serif mb-4 text-gray-800">
            {lang === "EN" ? content.ourBrand.title.EN : content.ourBrand.title.AR}
          </h2>
          <p className="text-gray-600 text-base md:text-lg leading-relaxed">
            {lang === "EN" ? content.ourBrand.description.EN : content.ourBrand.description.AR}
          </p>
        </div>
        ...
        <div className="bg-white mt-12 p-8 rounded-2xl shadow-md w-full md:w-4/5 flex flex-col items-center text-gray-700">
          <div className="flex flex-col md:flex-row justify-between w-full items-center gap-10 relative">
            {/* Left side */}
            <div className={`flex flex-col gap-8 md:w-1/3 ${lang === "EN" ? "text-left" : "text-right"}`} dir={lang === "EN" ? "ltr" : "rtl"}>
              <div>
                <h3 className="font-serif text-xl font-semibold text-gray-800">
                  {lang === "EN" ? content.symbols.mountain.title.EN : content.symbols.mountain.title.AR}
                </h3>
                <p className="text-sm md:text-base leading-relaxed">
                  {lang === "EN" ? content.symbols.mountain.description.EN : content.symbols.mountain.description.AR}
                </p>
              </div>
              <div>
                <h3 className="font-serif text-xl font-semibold text-gray-800">
                  {lang === "EN" ? content.symbols.river.title.EN : content.symbols.river.title.AR}
                </h3>
                <p className="text-sm md:text-base leading-relaxed">
                  {lang === "EN" ? content.symbols.river.description.EN : content.symbols.river.description.AR}
                </p>
              </div>
            </div>
            ...
            <div className="md:w-1/3 relative flex justify-center">
              <img src={logo} alt="Hasbani Logo" className="w-72 md:w-[26rem] lg:w-[32rem] object-contain" />
            ...
            {/* Right side */}
            <div className="flex flex-col gap-8 md:w-1/3" dir={lang === "EN" ? "ltr" : "rtl"}>
              <div>
                <h3 className="font-serif text-xl font-semibold text-gray-800">
                  {lang === "EN" ? content.symbols.tree.title.EN : content.symbols.tree.title.AR}
                </h3>
                <p className="text-sm md:text-base leading-relaxed">
                  {lang === "EN" ? content.symbols.tree.description.EN : content.symbols.tree.description.AR}
                </p>
              </div>
              <div>
                <h3 className="font-serif text-xl font-semibold text-gray-800">
                  {lang === "EN" ? content.symbols.bridge.title.EN : content.symbols.bridge.title.AR}
                </h3>
                <p className="text-sm md:text-base leading-relaxed">
                  {lang === "EN" ? content.symbols.bridge.description.EN : content.symbols.bridge.description.AR}
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="flex flex-col bg-gray-100 md:flex-row w-full h-auto">
        <div className="md:w-1/2 bg-[#414A38] text-white p-8 md:p-16 flex flex-col justify-center rounded-br-[80px] rounded-tr-[80px]">
          <div className="mb-8">
            <h2 className="text-3xl md:text-4xl font-serif font-bold mb-4" dir={lang === "EN" ? "ltr" : "rtl"} style={{ textAlign: lang === "EN" ? "left" : "right" }}>
              {lang === "EN" ? content.mission.title.EN : content.mission.title.AR}
            </h2>
            <p className="text-sm md:text-base leading-relaxed" dir={lang === "EN" ? "ltr" : "rtl"} style={{ textAlign: lang === "EN" ? "left" : "right" }}>
              {lang === "EN" ? content.mission.description.EN : content.mission.description.AR}
            </p>
          </div>
          <div>
            <h2 className="text-3xl md:text-4xl font-serif font-bold mb-4" dir={lang === "EN" ? "ltr" : "rtl"} style={{ textAlign: lang === "EN" ? "left" : "right" }}>
              {lang === "EN" ? content.vision.title.EN : content.vision.title.AR}
            </h2>
            <p className="text-sm md:text-base leading-relaxed" dir={lang === "EN" ? "ltr" : "rtl"} style={{ textAlign: lang === "EN" ? "left" : "right" }}>
              {lang === "EN" ? content.vision.description.EN : content.vision.description.AR}
            </p>
          </div>
        </div>
        <div className="md:w-1/2 w-full h-96 md:h-[500px] rounded-tl-[80px] rounded-bl-[80px] bg-cover bg-center bg-gray-100" style={{ backgroundImage: `url(${farmerImage})` }}></div>
      </div>
            <br />
      ...
      <div className="bg-[#414A38] py-16 px-4 md:px-12 lg:px-24 flex flex-col items-center">
        <h2 className="text-3xl md:text-4xl font-serif text-white mb-10 text-center">
          {lang === "EN" ? content.coreValues.title.EN : content.coreValues.title.AR}
        </h2>
        <div className="bg-white rounded-2xl shadow-md p-8 md:p-12 w-full md:w-11/12 lg:w-10/12 flex flex-col gap-10">
          {content.coreValues.values.map((v, i) => (
            <div key={i}>
              <div className={`flex items-start gap-6 ${lang === "EN" ? "flex-row" : "flex-row-reverse"}`}>
                {v.icon}
                <div style={{ textAlign: lang === "EN" ? "left" : "right" }}>
                  <h3 className="text-xl font-bold font-serif text-gray-800">{lang === "EN" ? v.title.EN : v.title.AR}</h3>
                  <p className="text-gray-600 text-sm md:text-base leading-relaxed">{lang === "EN" ? v.description.EN : v.description.AR}</p>
                </div>
              </div>
              {i < content.coreValues.values.length - 1 && <hr className="border-gray-400 mt-4" />}
            </div>
          ))}
        </div>
      </div>
      ...
      <div className="py-16 px-4 md:px-12 lg:px-24 flex flex-col items-center bg-gray-50">
        <h2 
          ...
          dir={lang === "AR" ? "rtl" : "ltr"}
        >
          {lang === "EN" ? content.whyChoose.title.EN : content.whyChoose.title.AR}
        </h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 w-full max-w-6xl">
          {content.whyChoose.cards.map((c) => (
            <div key={c.number} className={`relative group ${lang === "EN" ? "text-left" : "text-right"}`}>
              <div className={`absolute -top-7 ${lang === "EN" ? "-left-4 sm:-left-7" : "-right-4 sm:-right-7"} w-20 h-20 rounded-full border-4 border-gray-300 z-0`}></div>
              <div className={`absolute -top-3 text-4xl font-serif text-gray-800 z-10 ${lang === "EN" ? "left-0" : "right-0"}`}>{c.number}</div>
              <div className={`bg-white rounded-2xl p-6 md:p-8 relative z-20 shadow-[0_6px_25px_rgba(0,0,0,0.15)] border border-gray-200 transition-all duration-300 group-hover:shadow-[0_6px_30px_rgba(0,0,0,0.15)] ${lang === "EN" ? "ml-6" : "mr-6"}`} dir={lang === "AR" ? "rtl" : "ltr"}>
                <h3 className="text-xl font-semibold text-gray-800 mb-2">{lang === "EN" ? c.title.EN : c.title.AR}</h3>
                <p className="text-gray-600 text-sm md:text-base leading-relaxed">{lang === "EN" ? c.description.EN : c.description.AR}</p>
              </div>
            </div>
          ))}
        </div>
      ...
      {/* Our Story Section */}
      <section className={`w-full flex flex-col md:flex-row mb-1 ${lang === "AR" ? "md:flex-row-reverse" : ""}`}>
        {/* Left Text Block */}
        <div 
        ...
        >
          <div className="max-w-md mx-auto">
            ...
            >
              {lang === "EN" ? content.qualityStory.title.EN : content.qualityStory.title.AR}
            </h2>
            <div className={`space-y-4 text-sm md:text-base leading-relaxed flex-1 text-gray-100`}>
              { (lang === "EN" ? content.qualityStory.paragraphs.EN : content.qualityStory.paragraphs.AR).map((p, idx) => (
                <p key={idx}>{p}</p>
              )) }
            </div>
          </div>
        ...
        <div className="md:flex-1 h-auto">
          <img src={olives} alt="Our Story" className="w-full h-full object-cover" />
        </div>
      </section>
